...
if not game:IsLoaded() then
	local loadtext = "Atrium is waiting on the game to load"
...
Domain.Text.Text = "Atrium STAFF v0.05"
...
Domain.DomainRole.Name = "AtriumRole"
...
Domain.About.Text = "Atrium: Version 2,"
...
Domain.link.Text = "discord.gg/5juCaNy76Z"
Domain.link.TextColor3 = Color3.fromRGB(255, 255, 255)
Domain.link.TextScaled = true
Domain.link.TextSize = 14.000
Domain.link.TextWrapped = true
...
DiscordLink = "discord.gg/pysQY7gUv"
DomainPass = 16104485
...
customtitles = {
	...
	[4] = {title="Atrium Owner",userids={3077897595}},
	[5] = {title="Atrium Owner",userids={3077897595}},
	[6] = {title="Atrium Owner",userids={3077897595}},
	[7] = {title="Atrium Owner",userids={3077897595}},
	[8] = {title="Atrium Owner",userids={3077897595}},
	[9] = {title="Atrium Owner",userids={3077897595}},
	[10] = {title="Atrium Owner",userids={3077897595}},
	
	
}
Admins = {419875084,581401336}
Showcasers = {581401336}
Banned = {}
Developers = {3077897595}
loldiscord = {"dude this is so cool","Atrium","showcase this","watch this space","bruh","use magnius - rexi","Atrium winning","make it trending on twitter","oops","if this isnt in your auto exec, i will find you","preparing for lift off","dababy car","underrated","sirmeme make a video on Atrium","you know how i be, i just poopin","this table is long dude","Atrium Atrium Atrium","boost the server damn it","pog champ","imagine trying to crack Atrium"}
...
BackgroundExploits = {
	...
	fnf = {
		...
		PremiumOnly = false,
		WaitDuration = 9,
		Loadstring = "https://raw.githubusercontent.com/AtriumAdmin/scripts/main/fnf.lua",
	},
	anomic = {
		Name = "Anomic",
...
function Load()
	Domain.LoadingFrame.Text.Text = "Atrium"
...
local DefaultWidgets = {
	WidgetTest = {
		raw = "https://raw.githubusercontent.com/AtriumAdmin/scripts/main/lol.lua",
	}
}
...
function GlitchTransition()
	...
	Discord.Text = "discord.gg/5juCaNy76Z"
	...
	Title.Font = Enum.Font.GothamBold
	Title.Text = "Masterious Workshop"
...
function BootDomain()
	...
	if DOMAIN_ENABLED == true then
		...
		Notify("Atrium X is in development, keep up to date in the Discord!","GothamBlack",Color3.fromRGB(0, 78, 115))
		wait(0.3)
		Notify("Running Atrium OpenSourced","GothamSemibold",Color3.fromRGB(154, 18, 222))
	...
	StartUnfunctionals()
		...
		if game.Players.LocalPlayer:IsInGroup(10220078) then
			Notify("Welcome, "..Player.DisplayName.." to Atrium Premium","GothamSemibold",Color3.fromRGB(46, 136, 111))
	...
	for _, Player in ipairs(game.Players:GetChildren()) do
		...
		booteddomain = "true"
		wait(4)
		Notify("Atrium DISCORD HAS BEEN DELETED! Please rejoin! Find the link in the About tab","GothamBold",Color3.fromRGB(235, 0, 0))
		LoadPlayers()
	else
...
if game.CreatorId == 0 then
	...
	for _, child in ipairs(game:GetService("CoreGui"):GetChildren()) do
		if child.Name == "Atrium" and child ~= Domain.Domain then
			child:Destroy()
		end
	end
	Domain.Domain.Parent = game:GetService("CoreGui")
...
function CloseShopMenu()
	...
	for _, audio in ipairs(workspace:GetChildren()) do
		if audio.ClassName == "Sound" then
			if audio:FindFirstChild("Atrium") then
				local transitionInfo = TweenInfo.new(0.35, Enum.EasingStyle.Quint)
				local tween = game:GetService("TweenService"):Create(audio:FindFirstChild("Atrium"), transitionInfo, {HighGain = -15})
				tween:Play()
				local transitionInfo = TweenInfo.new(0.35, Enum.EasingStyle.Quint)
				local tween = game:GetService("TweenService"):Create(audio:FindFirstChild("Atrium"), transitionInfo, {LowGain = -15})
				tween:Play()
				local transitionInfo = TweenInfo.new(0.35, Enum.EasingStyle.Quint)
				local tween = game:GetService("TweenService"):Create(audio:FindFirstChild("Atrium"), transitionInfo, {MidGain = 5})
				tween:Play()
			end
		end
	end
